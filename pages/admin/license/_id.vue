<template>
  <div>
    ...
    />
    <postPreview v-if='data.body'  slug="license" :permalink="data.body.permalink" />
  </div>
</template>

<script>
import commonEdit from '~/components/templates/commonEdit'
import postMeta from '~/components/templates/meta/License'
import postRelative from '~/components/templates/relative/License'
import snackeBar from '~/components/templates/snackbar'
import postPreview from '~/components/lib/MM_Post_Preview'
import Guards from '~/guards'
    export default {
        name: "singleLicensePage",
        layout: 'admin',
