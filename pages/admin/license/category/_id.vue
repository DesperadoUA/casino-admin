<template>
  <div>
    ...
    />
    <postPreview v-if='data.body'  slug="licenses" :permalink="data.body.permalink" />
  </div>
</template>
...
import Guards from '~/guards'
    export default {
        name: "singleLicenseCategoryPage",
        layout: 'admin',
        ...
        data(){
          return {
              STORE_DIR: 'license/category',
              PATH_CATEGORY: 'license/category',
              data:{
                body: undefined
              },
              snackbar:{
